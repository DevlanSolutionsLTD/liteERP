                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms"  data-parent="#topAccordion">
                            <li>
                                <a href="form_bootstrap_basic.html"> Accounting </a>
                            </li>
                            <li>
                                <a href="form_input_group_basic.html"> Transfers </a>
                            </li>
                            <li>
                                <a href="form_layouts.html"> Transactions </a>
                            </li>
                            <li>
                                <a href="form_validation.html"> Reconciliations </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="page"  data-parent="#topAccordion">
                            <li>
                                <a href="pages_helpdesk.html"> Income Summary </a>
                            </li>
                            <li>
                                <a href="pages_contact_us.html"> Expense Summary </a>
                            </li>
                            <li>
                                <a href="pages_faq.html"> Profit / Loss </a>
                            </li>
                            <li>
                                <a href="pages_faq2.html"> HRM </a>
                            </li>
                            <li>
                                <a href="pages_privacy.html"> Products </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="more" data-parent="#topAccordion">
                            <li>
                                <a href="dragndrop_dragula.html"> General</a>
                            </li>
                            <li>
                                <a href="widgets.html"> Categories </a>
                            </li>
                            <li>
                                <a href="map_jvector.html"> Currencies </a>
                            </li>
                            <li>
                                <a href="charts_apex.html"> Tax Rates </a>
                            </li>
                        </ul>
                    </li>
                </ul>
